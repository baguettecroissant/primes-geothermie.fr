...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.primes-geothermie.fr/annuaire/${slug}`,
    },
  };
}
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white p-8 sm:p-12 rounded-2xl shadow-sm border border-stone-100">
          ...
          <p className="text-center text-stone-600 mb-10">
            Département {city.department_name} ({city.department_code}) — Trouvez les foreurs et aides MaPrimeRénov' dans votre ville.
          </p>
